...
const ACTION_LABELS: Record<string, string> = {
  ...
  PLAN_DELETE: 'Удаление тарифа',
  PAYMENT_REFUND: 'Возврат платежа',
  ANNOUNCEMENT_CREATE: 'Создание анонса',
  ANNOUNCEMENT_UPDATE: 'Изменение анонса',
  ANNOUNCEMENT_DELETE: 'Удаление анонса',
